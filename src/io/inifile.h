...
#ifndef PREFERENCES_EDITOR_INIFILE_H
#define PREFERENCES_EDITOR_INIFILE_H
...
namespace io {
    ...
    class PREFERENCES_EDITOR_IO_EXPORT IniFile : public GenericFile<IniFile, PolicyFileFormat<IniFile>>
    {
    public:
...
#endif // PREFERENCES_EDITOR_INIFILE_H
