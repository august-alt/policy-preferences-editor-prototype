...
#include "../plugins/administrative_templates/admx/policydefinitions.h"
 ...
 */
void PolicyDefinitionsFile::removePolicyDefinitions(
    std::shared_ptr<PolicyDefinitions> policyDefinitions)
{
    d->policyDefinitions.erase(
        std::remove_if(d->policyDefinitions.begin(),
