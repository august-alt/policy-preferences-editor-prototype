...
#ifndef PREFERENCES_EDITOR_REGISTRYFILEFORMAT_H
#define PREFERENCES_EDITOR_REGISTRYFILEFORMAT_H
...
namespace io {
    ...
    class PREFERENCES_EDITOR_IO_EXPORT RegistryFileFormat
    {
    public:
        std::string getName();
...
#endif // PREFERENCES_EDITOR_REGISTRYFILEFORMAT_H
