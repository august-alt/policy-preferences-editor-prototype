...
#ifndef PREFERENCES_EDITOR_GENERICFILE_H
#define PREFERENCES_EDITOR_GENERICFILE_H
...
namespace io {
    ...
    class PREFERENCES_EDITOR_IO_EXPORT GenericFile
    {
    public:
        GenericFile();
...
#endif // PREFERENCES_EDITOR_GENERICFILE_H
