...
#ifndef MVVM_FOLDERS_REGISTRY_WIDGET_H
#define MVVM_FOLDERS_REGISTRY_WIDGET_H
...
class RegistryWidget : public PreferenceWidgetInterface
{
public:
    Q_OBJECT
...
#endif//MVVM_FOLDERS_REGISTRY_WIDGET_H
