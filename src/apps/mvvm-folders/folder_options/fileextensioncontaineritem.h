...
#ifndef MVVM_FOLDERS_FILE_EXTENSION_CONTAINER_ITEM_H
#define MVVM_FOLDERS_FILE_EXTENSION_CONTAINER_ITEM_H
...
Q_DECLARE_METATYPE(::mvvm_folders::FileExtensionContainerItem)

#endif//MVVM_FOLDERS_FILE_EXTENSION_CONTAINER_ITEM_H
