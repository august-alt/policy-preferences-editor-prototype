...
#ifndef MVVM_FOLDERS_FILE_EXTENSION_ACTION_ITEM_H
#define MVVM_FOLDERS_FILE_EXTENSION_ACTION_ITEM_H
...
Q_DECLARE_METATYPE(::mvvm_folders::FileExtensionActionItem)

#endif // MVVM_FOLDERS_FILE_EXTENSION_ACTION_ITEM_H
