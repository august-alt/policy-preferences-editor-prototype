...
#ifndef MVVM_FOLDERS_FOLDER_OPTIONS_CONTAINER_ITEM_H
#define MVVM_FOLDERS_FOLDER_OPTIONS_CONTAINER_ITEM_H
...
#endif//MVVM_FOLDERS_FOLDER_OPTIONS_CONTAINER_ITEM_H
