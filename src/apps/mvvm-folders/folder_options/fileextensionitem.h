...
#ifndef MVVM_FOLDERS_FILEEXTENSION_ITEM_H
#define MVVM_FOLDERS_FILEEXTENSION_ITEM_H
...
Q_DECLARE_METATYPE(::mvvm_folders::FileExtensionItem)

#endif//MVVM_FOLDERS_FILEEXTENSION_ITEM_H
