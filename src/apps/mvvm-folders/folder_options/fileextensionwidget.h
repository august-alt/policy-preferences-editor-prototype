...
#ifndef MVVM_FOLDERS_FILEEXTENSION_WIDGET_H
#define MVVM_FOLDERS_FILEEXTENSION_WIDGET_H
...
class FileExtensionWidget : public PreferenceWidgetInterface
{
public:
    Q_OBJECT
...
#endif//MVVM_FOLDERS_FILEEXTENSION_WIDGET_H
