...
#ifndef MVVM_FOLDERS_SHORTCUTS_ITEM_H
#define MVVM_FOLDERS_SHORTCUTS_ITEM_H
...
Q_DECLARE_METATYPE(::mvvm_folders::ShortcutsItem)

#endif//MVVM_FOLDERS_SHORTCUTS_ITEM_H
