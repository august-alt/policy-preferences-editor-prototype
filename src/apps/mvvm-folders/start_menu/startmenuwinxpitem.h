...
#ifndef MVVM_FOLDERS_START_MENU_WIN_XP_ITEM_H
#define MVVM_FOLDERS_START_MENU_WIN_XP_ITEM_H
...
Q_DECLARE_METATYPE(::mvvm_folders::StartMenuWinXPItem)

#endif // MVVM_FOLDERS_START_MENU_WIN_XP_ITEM_H
