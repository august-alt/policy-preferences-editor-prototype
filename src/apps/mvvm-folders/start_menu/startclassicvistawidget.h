...
#ifndef MVVM_FOLDERS_STARTCLASSICVISTA_WIDGET_H
#define MVVM_FOLDERS_STARTCLASSICVISTA_WIDGET_H
...
class StartClassicVistaWidget : public PreferenceWidgetInterface
{
public:
    Q_OBJECT
...
#endif//MVVM_FOLDERS_STARTCLASSICVISTA_WIDGET_H
