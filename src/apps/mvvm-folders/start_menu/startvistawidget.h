...
#ifndef MVVM_FOLDERS_STARTVISTA_WIDGET_H
#define MVVM_FOLDERS_STARTVISTA_WIDGET_H
...
class StartVistaWidget : public PreferenceWidgetInterface
{
public:
    Q_OBJECT
...
#endif//MVVM_FOLDERS_STARTVISTA_WIDGET_H
