...
#ifndef MVVM_FOLDERS_LOCALUSER_ITEM_H
#define MVVM_FOLDERS_LOCALUSER_ITEM_H
...
Q_DECLARE_METATYPE(::mvvm_folders::LocalUserItem)

#endif//MVVM_FOLDERS_LocalUser_ITEM_H
