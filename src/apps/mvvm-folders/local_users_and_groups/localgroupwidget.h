...
#ifndef MVVM_FOLDERS_LOCALGROUP_WIDGET_H
#define MVVM_FOLDERS_LOCALGROUP_WIDGET_H
...
class LocalGroupWidget : public PreferenceWidgetInterface
{
public:
    Q_OBJECT
...
#endif//MVVM_FOLDERS_LOCALGROUP_WIDGET_H
