...
#ifndef MVVM_FOLDERS_SHARED_PRINTER_ITEM_H
#define MVVM_FOLDERS_SHARED_PRINTER_ITEM_H
...
Q_DECLARE_METATYPE(::mvvm_folders::SharedPrinterItem)

#endif//MVVM_FOLDERS_SHARED_PRINTER_ITEM_H
