...
#ifndef MVVM_FOLDERS_TCP_PRINTER_ITEM_H
#define MVVM_FOLDERS_TCP_PRINTER_ITEM_H
...
Q_DECLARE_METATYPE(::mvvm_folders::TcpPrinterItem)

#endif//MVVM_FOLDERS_TCP_PRINTER_ITEM_H
