...
#ifndef MVVM_FOLDERS_TCP_PRINTER_GENERAL_WIDGET_H
#define MVVM_FOLDERS_TCP_PRINTER_GENERAL_WIDGET_H
...
class TcpPrinterGeneralWidget : public PreferenceWidgetInterface
{
public:
    Q_OBJECT
...
#endif//MVVM_FOLDERS_TCP_PRINTER_GENERAL_WIDGET_H
