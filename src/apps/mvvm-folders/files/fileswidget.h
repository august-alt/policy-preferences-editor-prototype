...
#ifndef MVVM_FOLDERS_FILES_WIDGET_H
#define MVVM_FOLDERS_FILES_WIDGET_H
...
class FilesWidget : public PreferenceWidgetInterface
{
public:
    Q_OBJECT
...
#endif//MVVM_FOLDERS_FILES_WIDGET_H
