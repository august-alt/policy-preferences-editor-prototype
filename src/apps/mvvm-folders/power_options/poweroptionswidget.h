...
#ifndef MVVM_FOLDERS_POWER_OPTIONS_WIDGET_H
#define MVVM_FOLDERS_POWER_OPTIONS_WIDGET_H
...
class PowerOptionsWidget : public PreferenceWidgetInterface
{
public:
    Q_OBJECT
...
#endif//MVVM_FOLDERS_POWER_OPTIONS_WIDGET_H
