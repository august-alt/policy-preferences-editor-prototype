...
public:
    ...
    static std::unique_ptr<model::presentation::LongDecimalTextBox> create(
        const LongDecimalTextBox &widget)
    {
...
template<typename AdapterType,
         typename SequenceType = ::GroupPolicy::PolicyDefinitions::PolicyPresentation::TextSequence>
void adapt_widgets(
    const ::GroupPolicy::PolicyDefinitions::PolicyPresentation::TextSequence &sequence,
    std::map<std::string, std::shared_ptr<model::presentation::PresentationWidget>> &widgets)
{
    for (const auto &adaptee : sequence)
    {
...
public:
        ...
        : model::presentation::PolicyResources()
    {
        ...
        if (resources.resources().presentationTable().present())
        {
            for (const auto &presentation :
                 resources.resources().presentationTable()->presentation())
            {
                this->presentationTable[presentation.id()]
                    = std::make_shared<model::presentation::Presentation>();
                ...
                for (n = re->getFirstChild(); n != 0; n = n->getNextSibling())
                {
                    if (n->getNodeType() == xercesc::DOMNode::ELEMENT_NODE)
                    {
                        ...
                        {
                            auto checkBox
                                = std::make_unique<::GroupPolicy::PolicyDefinitions::CheckBox>(
                                    *elementNode);
                        ...
                        {
                            auto comboBox
                                = std::make_unique<::GroupPolicy::PolicyDefinitions::ComboBox>(
                                    *elementNode);
                        ...
                        {
                            auto decimalTextBox
                                = std::make_unique<::GroupPolicy::PolicyDefinitions::DecimalTextBox>(
                                    *elementNode);
                            widgets[decimalTextBox->refId()] = XsdDecimalTextBoxAdapter::create(
                                *decimalTextBox);
                        ...
                        {
                            auto dropdownList
                                = std::make_unique<::GroupPolicy::PolicyDefinitions::DropdownList>(
                                    *elementNode);
                            widgets[dropdownList->refId()] = XsdDropdownListAdapter::create(
                                *dropdownList);
                        ...
                        {
                            auto listBox
                                = std::make_unique<::GroupPolicy::PolicyDefinitions::ListBox>(
                                    *elementNode);
                        ...
                        {
                            auto longDecimalTextBox = std::make_unique<
                                ::GroupPolicy::PolicyDefinitions::LongDecimalTextBox>(*elementNode);
                            widgets[longDecimalTextBox->refId()]
                                = XsdLongDecimalTextBoxAdapter::create(*longDecimalTextBox);
                            widgetsVector.emplace_back(widgets[longDecimalTextBox->refId()]);
                        }
                        else if (elementType.compare("multiTextBox") == 0)
                        {
                            auto multiTextBox
                                = std::make_unique<::GroupPolicy::PolicyDefinitions::MultiTextBox>(
                                    *elementNode);
                            widgets[multiTextBox->refId()] = XsdMultiTextBoxAdapter::create(
                                *multiTextBox);
                        ...
                        {
                            auto textBox
                                = std::make_unique<::GroupPolicy::PolicyDefinitions::TextBox>(
                                    *elementNode);
                        ...
                        {
                            auto text = std::make_unique<::GroupPolicy::PolicyDefinitions::String>(
                                *elementNode);
    ...
    static std::unique_ptr<model::presentation::PolicyResources> create(
        const PolicyResources &resources)
    {
...
bool AdmlFormat::read(std::istream &input, io::PolicyResourcesFile *file)
{
    ...
    auto operation = [&]() {
        std::unique_ptr<::GroupPolicy::PolicyDefinitions::PolicyDefinitionResources>
            policyDefinitionResources = GroupPolicy::PolicyDefinitions::policyDefinitionResources(
                input,
                ::xsd::cxx::tree::flags::dont_validate | ::xsd::cxx::tree::flags::keep_dom
    ...
    return preferences_editor::ExceptionHandler::handleOperation(operation, errorHandler);
}
