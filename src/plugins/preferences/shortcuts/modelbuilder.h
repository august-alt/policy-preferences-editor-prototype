...
#ifndef PREFERENCES_EDITOR_SHORTCUTS_MODEL_BUILDER_H
#define PREFERENCES_EDITOR_SHORTCUTS_MODEL_BUILDER_H
...
#endif // PREFERENCES_EDITOR_SHORTCUTS_MODEL_BUILDER_H
