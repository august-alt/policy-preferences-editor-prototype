...
#ifndef PREFERENCES_EDITOR_COMMAND_LINE_PARSER_H
#define PREFERENCES_EDITOR_COMMAND_LINE_PARSER_H
...
namespace preferences_editor {
    ...
    class PREFERENCES_EDITOR_GUI_EXPORT CommandLineParser
    {
    public:
...
#endif // PREFERENCES_EDITOR_COMMAND_LINE_PARSER_H
