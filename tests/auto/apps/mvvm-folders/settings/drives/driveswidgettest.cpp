...
void DrivesWidgetTest::actionCreateDrivesWidgetTest_data()
{
    ...
    QTest::addRow("Create") << QString::fromStdString(dataPath + "drive_maps_action_create_with_no_path.xml") << "Create" << true << "" << true << true
                            << true << false << "Use:" << false << "Use first available, starting at:" << false << false << true << true << true;

    QTest::addRow("Replace")<< QString::fromStdString(dataPath + "drive_maps_action_replace_with_no_path.xml") << "Replace" << true << "" << true << true
                            << true << false << "Use:" << false << "Use first available, starting at:" << false << false << true << true << true;

    QTest::addRow("Update") << QString::fromStdString(dataPath + "drive_maps_action_update_with_no_path.xml") << "Update" << true << "" << true << true
                            << true << true << "Existing:" << false << "Use first available, starting at:" << true << true << true << true << true;

    QTest::addRow("Delete") << QString::fromStdString(dataPath + "drive_maps_action_delete_with_no_path.xml") << "Delete"<< false << "" << false << false
                            << false << true << "Delete:" << true << "Delete all, starting at:" << true << false << true << true << true;

    QTest::addRow("Create_with_path") << QString::fromStdString(dataPath + "drive_maps_action_create_with_path.xml") << "Create" << true << "C:\\path\\user1.txt"
                                      << true << true << true << true << "Use:" << true << "Use first available, starting at:" << true << true << true << true << true;

    QTest::addRow("Replace_with_path")<< QString::fromStdString(dataPath + "drive_maps_action_replace_with_path.xml") << "Replace" << true << "C:\\path\\user1.txt"
                                      << true << true << true << true << "Use:" << true << "Use first available, starting at:" << true << true << true << true << true;

    QTest::addRow("Update_with_path") << QString::fromStdString(dataPath + "drive_maps_action_update_with_path.xml") << "Update" << true << "C:\\path\\user1.txt"
                                      << true << true << true << true << "Use:" << true << "Use first available, starting at:" << true << true << true << true << true;

    QTest::addRow("Delete_with_path") << QString::fromStdString(dataPath + "drive_maps_action_delete_with_path.xml") << "Delete"<< false << "C:\\path\\user1.txt"
                                      << false << false << false << true << "Delete:" << true << "Delete all, starting at:" << true << false << true << true << true;
